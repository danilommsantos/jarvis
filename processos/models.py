...
class Processo(models.Model):
    ...
    # Relações Chave
    responsavel = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="meus_processos")
    ...
    obs_responsavel = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
